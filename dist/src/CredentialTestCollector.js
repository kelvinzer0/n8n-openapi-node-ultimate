...
exports.CredentialTestCollector = void 0;
 ...
 */
function scoreGetEndpoint(pattern, operation, doc) {
    var _a, _b;
    let score = 0;
    ...
    for (const req of security) {
        for (const schemeName of Object.keys(req)) {
            const scheme = (_b = (_a = doc.components) === null || _a === void 0 ? void 0 : _a.securitySchemes) === null || _b === void 0 ? void 0 : _b[schemeName];
            if (!scheme)
                continue;
    ...
    if (hasApiKey)
        score -= 30; // Best for testing
    if (hasHttp)
        score -= 20; // Good (bearer/basic)
    if (hasOAuth2)
        score += 20; // Harder to test
...
class CredentialTestCollector {
    ...
    get testRequest() {
        ...
        for (const req of effectiveSecurity) {
            for (const schemeName of Object.keys(req)) {
                const scheme = (_b = (_a = this.doc.components) === null || _a === void 0 ? void 0 : _a.securitySchemes) === null || _b === void 0 ? void 0 : _b[schemeName];
                if (!scheme)
                    continue;
                switch (scheme.type) {
                    case 'http': {
                        const schemeType = ((_c = scheme.scheme) === null || _c === void 0 ? void 0 : _c.toLowerCase()) || 'bearer';
     ...
     */
    buildTestRequestFor(pattern, method = 'GET') {
        const candidate = this.candidates.find(c => c.pattern === pattern && c.context.method.toLowerCase() === method.toLowerCase());
        if (!candidate)
            return null;
...
exports.CredentialTestCollector = CredentialTestCollector;
//# sourceMappingURL=CredentialTestCollector.js.map